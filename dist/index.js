...
/* harmony import */ var core_js_modules_es_promise__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./node_modules/core-js/modules/es.promise.js");
/* harmony import */ var core_js_modules_es_promise__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_promise__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var papaparse__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./node_modules/papaparse/papaparse.min.js");
...
async function drawNode(id, frame, fields, values) {
  ...
  await Promise.all(fields.map(async field => {
    ...
    switch (fieldType) {
      case 'TEXT':
        const [text] = newFrame.children.filter(childNode => {
      ...
      case 'RECTANGLE':
        const [rectImage] = newFrame.children.filter(childNode => {
      ...
      case 'ELLIPSE':
        const [circleImage] = newFrame.children.filter(childNode => {
...
figma.ui.onmessage = async msg => {
  ...
  if (msg.type === 'process-csv') {
    const csv = papaparse__WEBPACK_IMPORTED_MODULE_1___default.a.parse(msg.data.trim(), {
      header: true,
      delimiter: ','
    });
